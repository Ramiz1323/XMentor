...
import { createTestSchema, submitTestSchema, updateScoreSchema } from './mcq.validation.js';
...
router.patch('/:id/results/:resultId/score', authorize('TEACHER'), validate(updateScoreSchema), mcqController.updateScore);
